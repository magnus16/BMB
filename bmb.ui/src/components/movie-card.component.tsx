                ...
                <div className="card-body">
                    ...
                    {props.movie.description && <p className="card-text">{props.movie.description}</p>}
                    {
                        ...
                        <div className='cta-wrapper d-flex justify-content-center' style={ctaWrapper}>
                            {
                                props.showAddBtn ?
                                    isMovieInList ? <button type='button' onClick={removeMovieFromUserList} className='btn btn-sm btn-outline-primary me-auto'>
                                        <i className="bi bi-plus-lg me-1"></i>
                                        Remove Movie
                                    </button> : <button type='button' onClick={addMovieToUserList} className='btn btn-sm btn-outline-primary me-auto'>
                                        <i className="bi bi-plus-lg me-1"></i>
                                        Add Movie
                                    </button> :
                                    <></>
                            ...
                            {
                                props.showRateBtn ?
                                    <button type='button' className='ms-auto btn btn-sm btn-warning'>
